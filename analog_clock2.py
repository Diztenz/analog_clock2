...
# create background
bg = ui.PhotoImage(file='white_analog600x600.png')
...
minutes_hand_len = 175
hours_hand_len = 125

seconds_hand = canvas.create_line(300, 300, 300 + seconds_hand_len, 300 + seconds_hand_len, width=1.5, fill='red')
# minutes hand
minutes_hand = canvas.create_line(300, 300, 300 + minutes_hand_len, 300 + minutes_hand_len, width=2, fill='black')
# hours hand
hours_hand = canvas.create_line(300, 300, 300 + hours_hand_len, 300 + hours_hand_len, width=4, fill='black')
